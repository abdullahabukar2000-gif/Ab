...
# data/align/hand.json (then run align-auto.py for the rest). It stops and lists problems instead of writing.
A = {
...
json.dump({'translation': 'The Clear Quran, Dr. Mustafa Khattab', 'note': 'Hand-checked meaning groups (index of each group\'s last word) and the character ranges of the translation each group means. Generated by scripts/align-source.py; scripts/align-auto.py adds the rest.', 'verses': out},
          open(os.path.join(ROOT, 'data/align/hand.json'), 'w'), ensure_ascii=False, indent=0)
